...
final class ClotheDetailParamIpad: DisplayParam {
    ...
    static let starWidth: CGFloat = 23.29
    static let starHeight: CGFloat  = 19.91
    
    static let notationWidth: CGFloat = 89.7
    static let notationHeight: CGFloat = 45.72
    ...
    static var infosFont: Font = .title2
    static var heartFont: Font  = .body
